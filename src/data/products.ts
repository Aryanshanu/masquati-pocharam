...
export const products: Product[] = [
  ...
  // ==================== NAMKEEN & SWEETS ====================
  { id: "ns1", name: "Gulab Jamun", packSize: "6 Pieces", mrp: 120, category: "namkeen-sweets", badge: "bestseller" },
  { id: "ns2", name: "Gulab Jamun", packSize: "12 Pieces", mrp: 220, category: "namkeen-sweets" },
  { id: "ns3", name: "Rasgulla", packSize: "6 Pieces", mrp: 100, category: "namkeen-sweets", badge: "hot" },
  { id: "ns4", name: "Rasgulla", packSize: "12 Pieces", mrp: 180, category: "namkeen-sweets" },
  { id: "ns5", name: "Kaju Katli", packSize: "250g", mrp: 280, category: "namkeen-sweets", badge: "bestseller" },
  { id: "ns6", name: "Kaju Katli", packSize: "500g", mrp: 540, category: "namkeen-sweets" },
  { id: "ns7", name: "Motichoor Ladoo", packSize: "500g", mrp: 280, category: "namkeen-sweets", badge: "hot" },
  { id: "ns8", name: "Besan Ladoo", packSize: "500g", mrp: 260, category: "namkeen-sweets" },
  { id: "ns9", name: "Barfi Assorted", packSize: "500g", mrp: 320, category: "namkeen-sweets", badge: "bestseller" },
  { id: "ns10", name: "Soan Papdi", packSize: "250g", mrp: 120, category: "namkeen-sweets" },
  { id: "ns11", name: "Soan Papdi", packSize: "500g", mrp: 220, category: "namkeen-sweets", badge: "hot" },
  { id: "ns12", name: "Jalebi Fresh", packSize: "500g", mrp: 180, category: "namkeen-sweets", badge: "bestseller" },
  { id: "ns13", name: "Imarti Fresh", packSize: "500g", mrp: 200, category: "namkeen-sweets" },
  { id: "ns14", name: "Mysore Pak", packSize: "250g", mrp: 180, category: "namkeen-sweets" },
  { id: "ns15", name: "Peda", packSize: "250g", mrp: 200, category: "namkeen-sweets", badge: "hot" },
  { id: "ns16", name: "Kheer Kadam", packSize: "6 Pieces", mrp: 150, category: "namkeen-sweets", badge: "new" },
  { id: "ns17", name: "Namkeen Mix", packSize: "200g", mrp: 60, category: "namkeen-sweets" },
  { id: "ns18", name: "Namkeen Mix", packSize: "500g", mrp: 140, category: "namkeen-sweets", badge: "bestseller" },
  { id: "ns19", name: "Bhujia Sev", packSize: "200g", mrp: 55, category: "namkeen-sweets" },
  { id: "ns20", name: "Bhujia Sev", packSize: "500g", mrp: 130, category: "namkeen-sweets", badge: "hot" },
  { id: "ns21", name: "Aloo Bhujia", packSize: "200g", mrp: 50, category: "namkeen-sweets" },
  { id: "ns22", name: "Moong Dal", packSize: "200g", mrp: 65, category: "namkeen-sweets", badge: "bestseller" },
  { id: "ns23", name: "Khatta Meetha", packSize: "200g", mrp: 55, category: "namkeen-sweets" },
  { id: "ns24", name: "Mathri", packSize: "250g", mrp: 70, category: "namkeen-sweets", badge: "hot" },
  { id: "ns25", name: "Samosa (Frozen)", packSize: "6 Pieces", mrp: 90, category: "namkeen-sweets" },

  // ==================== BAKERY ====================
  { id: "b1", name: "Fresh Bread", packSize: "400g", mrp: 35, category: "bakery", badge: "bestseller" },
  { id: "b2", name: "Milk Bread", packSize: "400g", mrp: 45, category: "bakery" },
  { id: "b3", name: "Brown Bread", packSize: "400g", mrp: 50, category: "bakery", badge: "hot" },
  { id: "b4", name: "Multigrain Bread", packSize: "400g", mrp: 60, category: "bakery" },
  { id: "b5", name: "Pav Bun", packSize: "8 Pieces", mrp: 30, category: "bakery", badge: "bestseller" },
  { id: "b6", name: "Burger Bun", packSize: "4 Pieces", mrp: 40, category: "bakery" },
  { id: "b7", name: "Hot Dog Bun", packSize: "4 Pieces", mrp: 45, category: "bakery", badge: "new" },
  { id: "b8", name: "Butter Toast", packSize: "200g", mrp: 40, category: "bakery" },
  { id: "b9", name: "Rusk Plain", packSize: "300g", mrp: 55, category: "bakery", badge: "hot" },
  { id: "b10", name: "Rusk Elaichi", packSize: "300g", mrp: 65, category: "bakery" },
  { id: "b11", name: "Cake Rusk", packSize: "200g", mrp: 50, category: "bakery", badge: "bestseller" },
  { id: "b12", name: "Khari Biscuit", packSize: "200g", mrp: 45, category: "bakery" },
  { id: "b13", name: "Fan Cookies", packSize: "250g", mrp: 70, category: "bakery", badge: "hot" },
  { id: "b14", name: "Nankhatai", packSize: "250g", mrp: 80, category: "bakery", badge: "bestseller" },
  { id: "b15", name: "Fruit Cake", packSize: "200g", mrp: 90, category: "bakery" },
  { id: "b16", name: "Plum Cake", packSize: "200g", mrp: 95, category: "bakery", badge: "new" },
  { id: "b17", name: "Muffin Chocolate", packSize: "2 Pieces", mrp: 60, category: "bakery" },
  { id: "b18", name: "Croissant Plain", packSize: "2 Pieces", mrp: 70, category: "bakery", badge: "hot" },
  { id: "b19", name: "Puff Veg", packSize: "2 Pieces", mrp: 50, category: "bakery", badge: "bestseller" },
  { id: "b20", name: "Patties Veg", packSize: "2 Pieces", mrp: 55, category: "bakery" },

  // ==================== CHAT ====================
  { id: "c1", name: "Pani Puri Kit", packSize: "Complete Set", mrp: 80, category: "chat", badge: "bestseller" },
  { id: "c2", name: "Bhel Puri Kit", packSize: "Complete Set", mrp: 70, category: "chat" },
  { id: "c3", name: "Sev Puri Kit", packSize: "Complete Set", mrp: 75, category: "chat", badge: "hot" },
  { id: "c4", name: "Dahi Puri Kit", packSize: "Complete Set", mrp: 85, category: "chat" },
  { id: "c5", name: "Papdi Chat Kit", packSize: "Complete Set", mrp: 90, category: "chat", badge: "bestseller" },
  { id: "c6", name: "Ragda Pattice", packSize: "2 Servings", mrp: 100, category: "chat" },
  { id: "c7", name: "Samosa Chat Kit", packSize: "4 Pieces + Chutneys", mrp: 120, category: "chat", badge: "hot" },
  { id: "c8", name: "Aloo Tikki", packSize: "4 Pieces", mrp: 80, category: "chat" },
  { id: "c9", name: "Chat Masala", packSize: "100g", mrp: 35, category: "chat", badge: "bestseller" },
  { id: "c10", name: "Green Chutney", packSize: "200g", mrp: 40, category: "chat" },
  { id: "c11", name: "Sweet Chutney", packSize: "200g", mrp: 45, category: "chat", badge: "hot" },
  { id: "c12", name: "Papdi (Ready)", packSize: "200g", mrp: 50, category: "chat" },
];
