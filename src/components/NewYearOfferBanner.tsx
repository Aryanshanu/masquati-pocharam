...
const NewYearOfferBanner = () => {
  return (
    <div className="relative bg-gradient-to-r from-red-600 via-amber-500 to-red-600 py-3 px-4 overflow-hidden">
      ...
      <div
        className="absolute right-4 top-1/2 -translate-y-1/2 animate-pulse"
      ...
      {/* Content */}
      <div className="relative container mx-auto flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4">
        {/* Left section */}
        <div className="flex items-center gap-2">
          ...
          <Gift
            className="h-5 w-5 text-yellow-200 animate-bounce"
        ...
        <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-1">
          <span className="text-white font-body font-semibold text-xs md:text-sm text-center">
            1 Kg Cake + 1L Ice Cream @{" "}
            <span className="text-yellow-200 font-bold text-base md:text-lg">
              ₹599
            </span>{" "}
            only!
          </span>
